    ...
    var addButtons = function (dialog, buttonModel) {
        if (isDefinedAndNotNull(buttonModel)) {
            ...
            $.each(buttonModel, function (i, buttonConfig) {
                ...
                // create the button
                var button = $('<div class="button"></div>').append($('<span></span>').text(buttonConfig._buttonText));
        ...
        init: function (options) {
            return this.each(function () {
                ...
                if (!isDefinedAndNotNull(nfDialog.header) || nfDialog.header) {
                    ...
                    if (!isBlank(nfDialog._headerText)) {
                        dialogHeaderText.text(nfDialog._headerText);
                    }else if(!isBlank(nfDialog.headerText)){
