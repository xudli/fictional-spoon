...
nf.ContextMenu = (function () {
    ...
    var actions = [
        {condition: emptySelection, menuItem: {clazz: 'fa fa-refresh', text: 'Refresh',_text: '刷新', action: 'reload'}},
        {condition: isNotRootGroup, menuItem: {clazz: 'fa fa-level-up', text: 'Leave group',_text: '离开组', action: 'leaveGroup'}},
        {condition: isConfigurable, menuItem: {clazz: 'fa fa-gear', text: 'Configure',_text: '配置', action: 'showConfiguration'}},
        {condition: hasDetails, menuItem: {clazz: 'fa fa-gear', text: 'View configuration',_text: '刷新', action: 'showDetails'}},
        {condition: isProcessGroup, menuItem: {clazz: 'fa fa-sign-in', text: 'Enter group',_text: '进入组', action: 'enterGroup'}},
        {condition: isRunnable, menuItem: {clazz: 'fa fa-play', text: 'Start', _text: '开始',action: 'start'}},
        {condition: isStoppable, menuItem: {clazz: 'fa fa-stop', text: 'Stop',_text: '停止', action: 'stop'}},
        {condition: isRemoteProcessGroup, menuItem: {clazz: 'fa fa-cloud', text: 'Remote ports',_text: '远程端口', action: 'remotePorts'}},
        {condition: canStartTransmission, menuItem: {clazz: 'fa fa-bullseye', text: 'Enable transmission',_text: '启用传输',action: 'enableTransmission'}},
        {condition: canStopTransmission, menuItem: {clazz: 'icon icon-transmit-false', text: 'Disable transmission',_text: '禁用传输', action: 'disableTransmission'}},
        {condition: supportsStats, menuItem: {clazz: 'fa fa-area-chart', text: 'Status History',_text: '状态记录', action: 'showStats'}},
        {condition: canAccessProvenance, menuItem: {clazz: 'icon icon-provenance', imgStyle: 'context-menu-provenance', text: 'Data provenance',_text: '数据来源',action: 'openProvenance'}},
        {condition: isStatefulProcessor, menuItem: {clazz: 'fa fa-tasks', text: 'View state',_text: '查看状态', action: 'viewState'}},
        {condition: canMoveToFront, menuItem: {clazz: 'fa fa-clone', text: 'Bring to front', _text: '带到前面',action: 'toFront'}},
        {condition: isConnection, menuItem: {clazz: 'fa fa-long-arrow-left', text: 'Go to source',_text: '去源头', action: 'showSource'}},
        {condition: isConnection, menuItem: {clazz: 'fa fa-long-arrow-right', text: 'Go to destination',_text: '去目的地', action: 'showDestination'}},
        {condition: hasUpstream, menuItem: {clazz: 'icon icon-connect', text: 'Upstream connections',_text: '上游连接', action: 'showUpstream'}},
        {condition: hasDownstream, menuItem: {clazz: 'icon icon-connect', text: 'Downstream connections',_text: '下游连接', action: 'showDownstream'}},
        {condition: hasUsage, menuItem: {clazz: 'fa fa-book', text: 'Usage',_text: '用法', action: 'showUsage'}},
        {condition: isRemoteProcessGroup, menuItem: {clazz: 'fa fa-refresh', text: 'Refresh',_text: '刷新',action: 'refreshRemoteFlow'}},
        {condition: isRemoteProcessGroup, menuItem: {clazz: 'fa fa-external-link', text: 'Go to',_text: 'Go to', action: 'openUri'}},
        {condition: isColorable, menuItem: {clazz: 'fa fa-paint-brush', text: 'Change color', _text: '改变颜色',action: 'fillColor'}},
        {condition: isNotConnection, menuItem: {clazz: 'fa fa-crosshairs', text: 'Center in view',_text: '放中间', action: 'center'}},
        {condition: isCopyable, menuItem: {clazz: 'fa fa-copy', text: 'Copy', _text: '复制', action: 'copy'}},
        {condition: isPastable, menuItem: {clazz: 'fa fa-paste', text: 'Paste', _text: '粘贴', action: 'paste'}},
        {condition: canMoveToParent, menuItem: {clazz: 'fa fa-arrows', text: 'Move to parent group',_text: '移动到父组', action: 'moveIntoParent'}},
        {condition: canListQueue, menuItem: {clazz: 'fa fa-list', text: 'List queue',_text: '列表队列', action: 'listQueue'}},
        {condition: canEmptyQueue, menuItem: {clazz: 'fa fa-minus-circle', text: 'Empty queue',_text: '清空队列', action: 'emptyQueue'}},
        {condition: isDeletable, menuItem: {clazz: 'fa fa-trash', text: 'Delete', _text: '删除', action: 'delete'}}
    ];
