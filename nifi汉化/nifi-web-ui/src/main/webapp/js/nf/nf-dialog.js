...
nf.Dialog = (function () {
    ...
    return {
        ...
        showOkDialog: function (options) {
            ...
            // show the dialog
            $('#nf-ok-dialog').modal('setHeaderText', options._headerText).modal('show');
        },
        ...
        showYesNoDialog: function (options) {
            ...
            // show the dialog
            $('#nf-yes-no-dialog').modal('setHeaderText', options._headerText).modal('show');
        }
    };
}());