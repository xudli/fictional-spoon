...
<div id="history">
    <div id="history-header-text">NiFi历史记录</div>
    <div id="history-filter-container">
        ...
        <div style="float: right">
            ...
            <button id="history-filter-button" title="筛选历史记录" class="fa fa-filter"></button>
            <button id="history-purge-button" title="清洗历史记录" class="fa fa-eraser hidden"></button>
        </div>
        <div class="clear"></div>
    </div>
