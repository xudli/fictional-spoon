...
<md-toolbar id="header" layout-align="space-between center" layout="row" class="md-small md-accent md-hue-1">
    ...
    <div flex layout="row" layout-align="space-between center">
        <div id="component-container">
            <button title="{{appCtrl.serviceProvider.headerCtrl.toolboxCtrl.config.type._processor}}"
            ...
            <button title="{{appCtrl.serviceProvider.headerCtrl.toolboxCtrl.config.type._inputPort}}"
            ...
            <button title="{{appCtrl.serviceProvider.headerCtrl.toolboxCtrl.config.type._outputPort}}"
            ...
            <button title="{{appCtrl.serviceProvider.headerCtrl.toolboxCtrl.config.type._processGroup}}"
                    id="group-component"
            ...
            <button title="{{appCtrl.serviceProvider.headerCtrl.toolboxCtrl.config.type._remoteProcessGroup}}"
            ...
            <button title="{{appCtrl.serviceProvider.headerCtrl.toolboxCtrl.config.type._funnel}}"
                    id="funnel-component"
            ...
            <button title="{{appCtrl.serviceProvider.headerCtrl.toolboxCtrl.config.type._template}}"
            ...
            <button title="{{appCtrl.serviceProvider.headerCtrl.toolboxCtrl.config.type._label}}"
                    id="label-component"
            ...
            <div layout-align="space-between end" layout="column">
                ...
                <div id="logout-link-container" style="display: none;">
                    <span id="logout-link" class="link"
                          ng-click="appCtrl.serviceProvider.headerCtrl.logoutCtrl.logout();">登出</span>
                </div>
            </div>
