    ...
    <div id="summary-tabs-content">
        <div id="summary-filter-controls" class="filter-controls">
            <div id="summary-filter-status" class="filter-status">
                显示&nbsp;<span id="displayed-items"></span>&nbsp;of&nbsp;<span id="total-items"></span>
            </div>
        ...
        <div id="view-options-container">
            视图:&nbsp;
            <span id="view-single-node-link" class="link">单节点</span>&nbsp;&nbsp;<span id="view-cluster-link" class="link">集群</span>
        </div>
